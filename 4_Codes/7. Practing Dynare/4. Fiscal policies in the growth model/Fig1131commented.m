...
options_ = [];
M_.fname = 'Fig1131commented';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('Fig1131commented.log');
M_.exo_names = 'taui';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Fig1131commented_static');
erase_compiled_function('Fig1131commented_dynamic');
...
plot(qt)
title('q')
save('Fig1131commented_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Fig1131commented_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Fig1131commented_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Fig1131commented_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Fig1131commented_results.mat', 'estimation_info', '-append');
end
