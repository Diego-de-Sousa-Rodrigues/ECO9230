...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Fig1151_static');
erase_compiled_function('Fig1151_dynamic');
...
plot(qt)
title('q')
save('Fig1151_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Fig1151_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Fig1151_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Fig1151_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Fig1151_results.mat', 'estimation_info', '-append');
end
