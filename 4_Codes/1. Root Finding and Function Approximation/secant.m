...
% we can use this method since take the derivatives can be costly
% or even impossible to handle depend on the case
% f(z1, z2,...,zn)=0 with the secant method
% where x=[z1, z2,...,zn] is the solution vector.
% function 'func', which is a string.
% param corresponds to additonal parameters of the
% function 'func'.
% x0, crit, and maxit
...
% sol=secant('secexp1', 1, 4, 1e-3, 1000)