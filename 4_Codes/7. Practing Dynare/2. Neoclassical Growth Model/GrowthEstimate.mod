...
would like to estimate the preference parameters ? and ? , and the stochastic process for productivity, summarized
by two parameters ? and ?. The following code instructs Dynare to conduct the estimation
*\
